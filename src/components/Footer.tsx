    ...
    >
      <div className="flex">
        <div className="footer-logo w-[170px] md:w-[314px] h-[120px] md:h-[156px] relative">
          <Image
            src="https://assets-global.website-files.com/62cbe7a5c5049667d1ccf4b3/62d137c535f056cda8fcb767_geekpay.svg"
            width={75}
            height={14}
            alt="logo"
            className=" absolute top-[50%] md:top-[40%] group-hover:-top-[20%] transition-all duration-200"
          />
          <Image
            ...
            height={14}
            alt="logo"
            className="translate-y-[200px] group-hover:translate-y-0 transition-all duration-200 mx-auto"
          />
        </div>
      ...
      <div className="flex">
        <div className="w-full text-center text-xs md:text-sm pb-5 pt-2 text-white">
          <span>
            geekpay clone &copy; 2023 Sameh Hammad. All rights reserved.
          </span>
        </div>
      </div>
    </footer>
